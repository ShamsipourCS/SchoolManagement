...
public class TeacherRepository : GenericRepository<Teacher>, ITeacherRepository
{
    ...
    {
        return await _dbSet.FirstOrDefaultAsync(t => t.Email.Value == email);
    }

    public async Task<bool> EmailExistsAsync(string email, int? excludeTeacherId = null)
    {
        return await _dbSet.AnyAsync(t => t.Email.Value == email && (!excludeTeacherId.HasValue || t.Id != excludeTeacherId.Value));
    }
}
